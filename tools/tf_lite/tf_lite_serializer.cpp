...
static bool LoadFullyConnected(LiteNode* node, LiteGraph* lite_graph, StaticGraph* graph)
{
    ...
    const tflite::FullyConnectedOptions* lite_param =
        node->lite_op->builtin_options_as<tflite::FullyConnectedOptions>();
...
static bool LoadResizeNearestNeighbor(LiteNode* node, LiteGraph* lite_graph, StaticGraph* graph)
{
    ...
    // const tflite::ResizeNearestNeighborOptions* lite_param =
    // node->lite_op->builtin_options_as<tflite::ResizeNearestNeighborOptions>();
    auto* buffers = lite_graph->lite_model->buffers();
...
{
    StaticNode* static_node = node->static_node;
    const tflite::StridedSliceOptions* stridedslice_param =
        node->lite_op->builtin_options_as<tflite::StridedSliceOptions>();
...
static bool LoadDepthToSpace(LiteNode* node, LiteGraph* lite_graph, StaticGraph* graph)
{
    ...
    // const tflite::SpaceToDepthOptions* spacetodepth_param =
    // node->lite_op->builtin_options_as<tflite::SpaceToDepthOptions>();
