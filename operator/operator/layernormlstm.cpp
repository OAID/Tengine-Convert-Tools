...
void LayerNormLSTM::SetSchema(void)
{
    ...
    Input({"input:float32",
           ...
           "projection_bias:float32",
           "iactivationstateTensor:float32",
           "icellstatetensor:float32",
           "ilayer_norm_coefficients:float32",
           "flayer_norm_coefficients:float32",
           "clayer_norm_coefficients:float32",
           "olayer_norm_coefficients:float32"})
