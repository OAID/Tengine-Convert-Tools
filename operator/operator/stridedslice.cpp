                              ...
                              int layout)
{
...

    {
        std::vector<int> o_dim = input.GetDim();
        int delta_0 =
            (-param_.begin[0] + param_.end[0]) < 0 ? param_.begin[0] - param_.end[0] : -param_.begin[0] + param_.end[0];
        int delta_1 =
            (-param_.begin[1] + param_.end[1]) < 0 ? param_.begin[1] - param_.end[1] : -param_.begin[1] + param_.end[1];
        int delta_2 =
            (-param_.begin[2] + param_.end[2]) < 0 ? param_.begin[2] - param_.end[2] : -param_.begin[2] + param_.end[2];
        int delta_3 =
            (-param_.begin[3] + param_.end[3]) < 0 ? param_.begin[3] - param_.end[3] : -param_.begin[3] + param_.end[3];
